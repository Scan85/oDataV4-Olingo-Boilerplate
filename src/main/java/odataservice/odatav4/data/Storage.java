package odataservice.odatav4.data;

import odataservice.odatav4.service.EdmProvider;
import odataservice.odatav4.util.Util;
...
public class Storage {
	 ...
	 // represent our database
	  ...
	  public EntityCollection readEntitySetData(EdmEntitySet edmEntitySet) {
	    ...
	    } else if (edmEntitySet.getName().equals(EdmProvider.ES_CATEGORIES_NAME)) {
	  ...
	  public Entity readEntityData(EdmEntitySet edmEntitySet, List<UriParameter> keyParams) {
	    ...
	    } else if (edmEntityType.getName().equals(EdmProvider.ET_CATEGORY_NAME)) {
	  ...
	  public EntityCollection getRelatedEntityCollection(Entity sourceEntity, EdmEntityType targetEntityType) {
	    ...
	    if (sourceEntityFqn.equals(EdmProvider.ET_PRODUCT_FQN.getFullQualifiedNameAsString())
	        && relatedEntityFqn.equals(EdmProvider.ET_CATEGORY_FQN)) {
	      navigationTargetEntityCollection.setId(createId(sourceEntity, "ID", EdmProvider.NAV_TO_CATEGORY));
	    ...
	    } else if (sourceEntityFqn.equals(EdmProvider.ET_CATEGORY_FQN.getFullQualifiedNameAsString())
	        && relatedEntityFqn.equals(EdmProvider.ET_PRODUCT_FQN)) {
	      navigationTargetEntityCollection.setId(createId(sourceEntity, "ID", EdmProvider.NAV_TO_PRODUCTS));
	  ...
	  private void initProductSampleData() {
	    ...
	    entity.setType(EdmProvider.ET_PRODUCT_FQN.getFullQualifiedNameAsString());
	  ...
	  private void initCategorySampleData() {
	    ...
	    entity.setType(EdmProvider.ET_CATEGORY_FQN.getFullQualifiedNameAsString());
	    entity.setId(createId(entity, "ID"));
	  ...
	  private String getEntitySetName(Entity entity) {
	    if(EdmProvider.ET_CATEGORY_FQN.getFullQualifiedNameAsString().equals(entity.getType())) {
	      return EdmProvider.ES_CATEGORIES_NAME;
	    } else if(EdmProvider.ET_PRODUCT_FQN.getFullQualifiedNameAsString().equals(entity.getType())) {
	      return EdmProvider.ES_PRODUCTS_NAME;
	    }
